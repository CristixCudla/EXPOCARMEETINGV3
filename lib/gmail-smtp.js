  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 14px; color: #cccccc; margin-top: 30px;">
        Dacă ai întrebări, ne poți contacta la <a href="mailto:expocarmeeting@gmail.com" style="color: #00bcd4; text-decoration: none;">expocarmeeting@gmail.com</a>
      </p>
    </div>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 14px; color: #ffffff; margin-top: 30px; padding: 15px; background: rgba(239, 68, 68, 0.1); border-radius: 8px;">
        ...
        <span style="color: #e5e5e5;">Deschide un ticket și echipa noastră îți va răspunde cu toate detaliile. Poate există motive tehnice sau organizatorice pe care le putem clarifica împreună!</span>
      </p>
      
      <p style="font-size: 14px; color: #cccccc; margin-top: 20px;">
        Contact: <a href="mailto:expocarmeeting@gmail.com" style="color: #00bcd4; text-decoration: none;">expocarmeeting@gmail.com</a>
      </p>
    </div>
...
<head>
  ...
  <style>
    ...
    .footer { background: #0a0a0a; padding: 20px; text-align: center; font-size: 12px; color: #999999; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="color: #cccccc;">Email: <a href="mailto:${email}" style="color: #00bcd4; text-decoration: none;">${email}</a></p>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="message-box">
        <p style="color: #cccccc; font-size: 14px; margin-bottom: 10px;"><strong style="color: #ffffff;">De la:</strong> ${created_by_name}</p>
        <p style="color: #e5e5e5; white-space: pre-wrap;">${message}</p>
      </div>
