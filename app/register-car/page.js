      ...
      <div className=\"max-w-3xl mx-auto\">
        ...
        <Card className=\"neon-card bg-black/40 backdrop-blur-xl border-white/20\">
          <CardHeader className=\"text-center\">
            ...
            <p className=\"text-white/50 text-sm mt-2\">Completează formularul pentru a participa la Expo Car Meeting 2026</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className=\"space-y-6\">
              <div className=\"grid md:grid-cols-2 gap-4\">
                <div className=\"space-y-2\">
                  <Label htmlFor=\"make\" className=\"text-white/70 text-sm font-medium\">Marcă *</Label>
                  <Input
                    id=\"make\"
                ...
                <div className=\"space-y-2\">
                  <Label htmlFor=\"model\" className=\"text-white/70 text-sm font-medium\">Model *</Label>
                  <Input
                    id=\"model\"
              ...
              <div className=\"space-y-2\">
                <Label htmlFor=\"year\" className=\"text-white/70 text-sm font-medium\">An fabricație</Label>
                <Input
                  id=\"year\"
                  type=\"number\"
                  placeholder=\"ex: 2023\"
              ...
              <div className=\"space-y-2\">
                <Label htmlFor=\"description\" className=\"text-white/70 text-sm font-medium\">Descriere</Label>
                <Textarea
                  id=\"description\"
